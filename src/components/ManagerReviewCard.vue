            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-body">
                  <input class="form-control" type="url" :id="`img_url${props.data.pm_rating_id}`" placeholder="Paste link here..." />
                  <button @click.prevent="post_image(props.data.pm_rating_id)" type="button" data-bs-dismiss="modal"
